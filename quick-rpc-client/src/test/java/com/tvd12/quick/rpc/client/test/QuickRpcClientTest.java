...
public class QuickRpcClientTest extends BaseTest {
    ...
    protected final String clientName = "testClientName";
    protected final int clientCapacity = 100;
    protected final String clientUsername = "testUsername";
    protected final String clientPassword = "testPassword";
    protected final String clientHost = "testHost";
    protected final int clientPort = 3005;
    protected final int clientThreadPoolSize = 3;
    protected final int clientProcessEventInterval = 3;
    protected final int clientDefaultRequestTimeout = 5000;
    ...
    //	@Test
    public void submitGetObjectError() {
        // given
        QuickRpcClient sut = makeQuickRpcClient(false);
        ...
        try {
            ...
            RpcErrorException ex = (RpcErrorException) e.getCause();
            RpcBadRequestErrorData data = ex.getErrorData(RpcBadRequestErrorData.class);
            assert data.getCode() == 1;
            assert data.getMessage().equals("name too short");
        }
    ...
    private QuickRpcClient.Builder makeQuickRpcClientBuilder(
        ...
        Function<EzyClientConfig, EzyClient> clientSupplier =
            config -> new EzyTcpClient(config) {
    ...
    private QuickRpcClient.Builder newQuickRpcClientBuilder(
        ...
        return new QuickRpcClientForTest.Builder()
            ...
            .scan(Collections.singletonList("com.tvd12.quick.rpc.client.test.data"));
    }
